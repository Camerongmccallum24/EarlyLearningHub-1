...
const LocationInfo = ({ locationName, showButton = true }: LocationInfoProps) => {
  ...
  const LocationDialog = () => (
    <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
      <DialogHeader>
        <DialogTitle className="text-2xl font-bold text-gro-darkblue flex items-center">
          <MapPin className="h-6 w-6 mr-2 text-gro-teal" />
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <DollarSign className="h-5 w-5 mr-2 text-gro-teal" />
                Housing Costs
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="lifestyle" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Heart className="h-5 w-5 mr-2 text-gro-teal" />
                  Community Overview
                </CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <GraduationCap className="h-5 w-5 mr-2 text-gro-teal" />
                  Education
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Stethoscope className="h-5 w-5 mr-2 text-gro-teal" />
                  Healthcare
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                  <Heart className="h-4 w-4 mr-2 text-gro-teal" />
                  Recreation
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                  <ShoppingBag className="h-4 w-4 mr-2 text-gro-teal" />
                  Shopping
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                  <Utensils className="h-4 w-4 mr-2 text-gro-teal" />
                  Dining
                </CardTitle>
              </CardHeader>
              <CardContent>
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button 
          variant="outline" 
          size="sm"
          className="hover:bg-gro-teal/10 hover:border-gro-teal"
        >
