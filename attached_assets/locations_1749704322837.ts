export const locations = [
  {
    ...
    phone: '(07) 4743 8123',
    email: 'mountisa@groearlylearning.com',
    description: `GRO Early Learning Mount Isa offers premium early childhood education and care for children aged 6 weeks to 6 years. Our family-owned centre provides a nurturing environment with five spacious rooms, engaging outdoor nature play areas, and a dedicated kitchen where our qualified chef prepares nutritious meals daily. We supply all essentials, including nappies, wipes, sunscreen, and even a complimentary t-shirt and hat upon enrolment. Our programs, aligned with the Early Years Learning Framework, focus on holistic development through play-based learning, STEM exploration, and our unique Mini Master Chef classes. Located in the heart of Mount Isa, we are committed to fostering growth through care, curiosity, and community.`,
    mapUrl: 'https://www.google.com/maps/place/Gro+Early+Learning/@-20.7211523,139.4917176,17z/data=!4m15!1m8!3m7!1s0x6a1652e37073f7df:0x4bbfc46de4f5732!2s60-62+West+St,+Menzies+QLD+4825,+Australia!3b1!8m2!3d-20.7211523!4d139.4917176!16s%2Fg%2F11y42c7wwp!3m5!1s0x6a1653be67302385:0x9afab035956f8970!8m2!3d-20.7211523!4d139.4917176!16s%2Fg%2F11vz4pdy37?entry=ttu&g_ep=EgoyMDI1MDUyNy4wIKXMDSoASAFQAw%3D%3D',
    costOfLiving: {
      averageRent: {
    ...
    lifestyle: {
      ...
      education: {
        schools: ['Mount Isa State High School', 'Good Shepherd Catholic College', 'Several primary schools'],
      ...
      statsSource: 'ABS (Population), Mount Isa Council (Vibe)' // Consolidated/updated source notes
      // ------------------------------------
    }
  },
  {
    ...
    phone: '(07) 4941 7456',
    email: 'moranbah@groearlylearning.com',
    description: `Anticipated to open in January 2026, GRO Early Learning Moranbah will extend our commitment to high-quality early childhood education to the Isaac region. Our purpose-built centre will cater to children aged 6 weeks to 6 years, offering programs that emphasize play-based learning, nature exploration, and holistic development. Families can expect the same premium services as our Mount Isa centre, including nutritious meals prepared onsite, provision of all care essentials, and engaging programs like STEM and Mini Master Chef. Join our waitlist today to secure a place for your child in this exciting new facility.`,
    ...
    lifestyle: {
      ...
      education: {
        schools: ['Moranbah State High School', 'Moranbah State School', 'Moranbah East State School', 'Moranbah Early Learning Centre'],
  ...
  },
  {
    ...
    phone: '(07) 4787 3214',
    email: 'charterstowers@groearlylearning.com',
    description: `Scheduled to open in January 2026, GRO Early Learning Charters Towers will bring our exceptional early learning programs to families in the Charters Towers region. Our new centre will provide care for children aged 6 weeks to 6 years, featuring state-of-the-art facilities designed to inspire and nurture young minds. With a focus on play-based learning, outdoor nature play, and comprehensive programs like STEM and Mini Master Chef, we aim to create a supportive environment where children can thrive. Essential items such as meals, nappies, wipes, and sunscreen will be provided. Register your interest now to be part of our growing community.`,
    mapUrl: 'https://www.google.com/maps/place/Gro+Early+Learning+Charters+Towers/@-20.0707908,146.2796241,17z/data=!4m15!1m8!3m7!1s0x6bd45e88309a679b:0x9a2662551c1e905d!2s1+Cavey+Cct,+Queenton+QLD+4820,+Australia!3b1!8m2!3d-20.0707908!4d146.2796241!16s%2Fg%2F11lds4c548!3m5!1s0x6bd45f168e389339:0xb511c0c6f92b5d79!8m2!3d-20.0707908!4d146.2796241!16s%2Fg%2F11xg46w3tt?entry=ttu&g_ep=EgoyMDI1MDUyOC4wIKXMDSoASAFQAw%3D%3D',
    costOfLiving: {
      averageRent: {
        studio: '$200-280/week',
    ...
    lifestyle: {
      ...
      education: {
        schools: ['Charters Towers State High School', 'All Souls St Gabriels School', 'Blackheath and Thornburgh College', 'Several primary schools'],
...
// Updated interfaces to reflect new fields for better type safety
...
export interface Lifestyle {
  ...
  communityVibe: string; // Added field
  partnerEmploymentOpportunities: string; // Added field
  proximityToMajorHubs: string; // Added field
  statsSource?: string;
}
