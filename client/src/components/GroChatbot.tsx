    ...
    <div className="fixed bottom-4 right-4 z-50">
      ...
      {!isOpen && (
        <button
          ...
          className="hover:bg-gro-teal/90 rounded-full p-3 sm:p-4 shadow-lg ring-2 ring-white/20 backdrop-blur-sm transition-all duration-300 hover:scale-110 hover:shadow-xl animate-pulse-subtle animate-float button-press text-[#ffffff] bg-[#4682B4]"
